...
def load():
    ...
    user1 = User(email_address='test1@test.com',
                 password_hash=password1, salt=salt1)

    password2, salt2 = hash_password('test2')
    user2 = User(email_address='test2@test.com',
                 password_hash=password2, salt=salt2)

    session = SessionLocal()

    tag_math = Tag(
        name='算術理解', tutorial_link='https://developer.mozilla.org/ja/docs/Web/JavaScript/Guide/Expressions_and_Operators')
    tag_func = Tag(
        name='関数理解', tutorial_link='https://developer.mozilla.org/ja/docs/Web/JavaScript/Guide/Functions')
    ...
    question1 = Question(title='add 2 values',
                         ...
                         test_cases=testcase1, assertions=assertions1, tags=[
                             tag_math, tag_func],
    ...
    question2 = Question(title='add 3 values',
                         ...
                         test_cases=testcase2, assertions=assertions2, tags=[
                             tag_math, tag_func],
